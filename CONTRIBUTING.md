# Contributing to fw-pwrctl

## Getting started

fw-pwrctl is a small, focused project. Contributions are welcome — bug
...
Run from the repo root:
    ...
    python3 tests/test_fw_pwrctl.py

For live hardware tests (requires Framework laptop + root):

    sudo python3 tests/test_fw_pwrctl.py --live
