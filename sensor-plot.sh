...
#
# Reads sensor-log.json (JSONL produced by fw_pwrctl daemon's SensorLogger)
...
show_help() {
    ...
    echo "  --log-dir DIR        Log directory (default: /var/log/fw-pwrctl)"
...
if [[ ${#LOG_FILES[@]} -eq 0 ]]; then
    ...
    echo "  Is fw-pwrctl running? Check: sudo systemctl status fw-pwrctl" >&2
